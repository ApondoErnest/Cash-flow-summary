...
Route::get('/imports/{import}/errors/download', \App\Modules\CsvImports\Http\Controllers\ImportErrorDownloadController::class)->name('imports.errors.download');
Route::get('/imports/{import}/result', \App\Modules\CsvImports\Livewire\ImportResultPage::class)->name('imports.result');
Route::get('/verifications/{token}/errors/download', \App\Modules\CsvVerification\Http\Controllers\VerificationErrorDownloadController::class)->name('verifications.errors.download');
