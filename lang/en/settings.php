...
return [
    ...
    'whatsapp' => [
        ...
        'test_help' => 'Send a hello_world template message to each saved owner number using the saved credentials. During Meta app development, add every recipient number to the allowed list in Meta Business Manager.',
        ...
        'test_sent_partial' => 'Test message sent to :sent_phones. Failed for :failed_summary. Last Meta message ID: :message_id',
