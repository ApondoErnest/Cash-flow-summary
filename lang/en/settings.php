...
return [
    ...
    'whatsapp' => [
        ...
        'incomplete_notice' => 'Enter the owner phone number(s), phone number ID, and access token to enable outbound WhatsApp notifications.',
        ...
        'test_help' => 'Send a hello_world template message to each saved owner number using the saved credentials.',
        'test_sent' => 'Test message sent to :phone. Meta message ID: :message_id',
        'test_sent_all' => 'Test messages sent to :phones. Last Meta message ID: :message_id',
        'test_not_configured' => 'Save the owner phone number(s), phone number ID, and access token before sending a test message.',
        'test_failed' => 'WhatsApp test message failed: :error',
        'saving' => 'Saving…',
        'notifications_title' => 'Configuration',
        'fields' => [
            'owner_phone' => 'Owner WhatsApp number(s)',
            'owner_phone_help' => 'Receives operational alerts and scheduled summaries. Enter one or more numbers in E.164 format, separated by commas.',
        ...
        'placeholders' => [
            'owner_phone' => '+237612345678, +237698765432',
        ...
        'validation' => [
            'owner_phone' => 'Enter one or more valid WhatsApp numbers in E.164 format, separated by commas.',
        ],
    ],
