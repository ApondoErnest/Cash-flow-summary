...
return [
    ...
    'whatsapp' => [
        ...
        'incomplete_notice' => 'Saisissez le(s) numéro(s) du propriétaire, l’ID du numéro et le jeton d’accès pour activer les notifications WhatsApp sortantes.',
        ...
        'test_sending' => 'Envoi…',
        'test_help' => 'Envoie le modèle hello_world à chaque numéro enregistré du propriétaire avec les identifiants enregistrés.',
        'test_sent' => 'Message test envoyé à :phone. ID Meta : :message_id',
        'test_sent_all' => 'Messages test envoyés à :phones. Dernier ID Meta : :message_id',
        'test_not_configured' => 'Enregistrez le(s) numéro(s) du propriétaire, l’ID du numéro et le jeton d’accès avant d’envoyer un message test.',
        'test_failed' => 'Échec du message test WhatsApp : :error',
        'saving' => 'Enregistrement…',
        'notifications_title' => 'Configuration',
        'fields' => [
            'owner_phone' => 'Numéro(s) WhatsApp du propriétaire',
            'owner_phone_help' => 'Reçoit les alertes opérationnelles et les résumés programmés. Saisissez un ou plusieurs numéros au format E.164, séparés par des virgules.',
        ...
        'validation' => [
            'owner_phone' => 'Saisissez un ou plusieurs numéros WhatsApp valides au format E.164, séparés par des virgules.',
        ],
    ],
