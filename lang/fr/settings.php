...
return [
    ...
    'whatsapp' => [
        ...
        'test_sending' => 'Envoi…',
        'test_help' => 'Envoie le modèle hello_world à chaque numéro enregistré du propriétaire avec les identifiants enregistrés. En phase de développement Meta, ajoutez chaque numéro destinataire à la liste autorisée dans Meta Business Manager.',
        ...
        'test_sent_partial' => 'Message test envoyé à :sent_phones. Échec pour :failed_summary. Dernier ID Meta : :message_id',
